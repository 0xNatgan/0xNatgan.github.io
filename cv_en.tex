...
\noindent\textbf{French driving license (Permis B)} 
\noindent\textbf{Geographic mobility: entire France - international}
...
\noindent\textbf{Volunteer IT park managment and Treasurer -- Jeunes sciences Bordeaux}\\ \hfill \textit{2019 -- 2025 Bordeaux}
\begin{itemize}
    \item Management and maintenance of the IT park with the use of GLPI
    \item Technical support for users
    \item Maintenance of computer equipment
\end{itemize}

\noindent\textbf{CS and Robotics courses designer and instructor -- Jeunes sciences Bordeaux}\\ \hfill \textit{2019 -- 2025 Bordeaux}
\begin{itemize}
    \item Designed and led robotics and computer science courses for young people aged 8 to 17
\end{itemize}

\noindent\textbf{Summer Job in Catering}\\ \hfill \textit{Summer 2021 to 2024 Bordeaux}
\begin{itemize}
    \item 2021 Eklo Bordeaux -- Floor runner, order taking, and bartender
...
\indent Master's in Artificial Intelligence. Specialization in Advanced Databases\\

\noindent\textbf{Bachelor's in Computer Science -- University of Bordeaux} \hfill \textit{2020 -- 2024}\\

\noindent\textbf{Web Developer Training -- LeWagon} \hfill \textit{Sept -- Nov 2021}\\
...
\begin{itemize}
    ...
    \item DocGen\_LLM is a code documentation generation tool that uses language models in conjunction with language servers to create concise context for low capacity models in order to create clear and concise documentation for an entire project codebase. It is designed to be programming language agnostic. The tool easily integrates with documentation reading tools like mkdocs. It allows generating documentation to be added to the code or used in external documentation using Markdown or HTML.
\end{itemize}
